...
class JS extends Minify
{
    ...
    public function minify($path = null)
    {
        ...
        /*
         * Property notation can only be done before or after extracting and
         * restoring strings, since the associative array key will be a string.
         */
