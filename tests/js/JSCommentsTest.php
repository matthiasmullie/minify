...
/**
 * JS minifier test case with comments perverse.
 */
class JSCommentsTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var Minify\JS
     */
    ...
    /**
     * Test minifier configuration method.
     *
     * @test
     */
    public function setConfig()
    {
        ...
        $property = $object->getProperty('leavePreservedComments');
        $property->setAccessible(true);
        $this->assertEquals($property->getValue($this->minifier), true);
    }
 ...
 */',
            '/*!*jQuery JavaScript Library v2.2.4*http://jquery.com/
